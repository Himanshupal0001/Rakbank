...
function SummeryContent({ item, isLast }) {
    return (
        ...
        >
            <div className='w-4/5'>
                <div className='font-medium text-xl' data-testid='main-title'>{item.Title}</div>
                {!isLast && (<div className='text-xs text-gray-400' data-testid='small-title'>{item.Title}</div>)}
